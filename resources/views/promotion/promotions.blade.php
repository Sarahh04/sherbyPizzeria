<x-app-layout>
    <div class = "flex flex-row w-full justify-center mt-24">
        ...
        <button type="submit" name="add_promo" value="add_promo" >
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                        ...
                        <div class="flex flex-row justify-center mt-8 mb-20">
                            <label for="filtre_promo" class = "mr-24 mt-2">Filtré : </label>
                            <input type="text" name = "filtre_promo_nom" class = "mr-24 rounded">
                            <select name="filtre_promo_en_cours" class="mr-24 rounded">

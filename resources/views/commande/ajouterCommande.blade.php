                ...
                <form class="w-full max-w-m m-auto">
                    ...
                    <div class="md:flex md:items-center mb-6">
                        ...
                        <div class="md:w-4/5 flex h-11">
                            ...
                            <div class="md:w-1/2 flex">
                                ...
                                <img class="block h-9 w-auto fill-current text-gray-800" type="image" src="{{ asset('image/ajouter-icon.png') }}" alt="ajouter Pizza" id="ajouterElement">
                    ...
                    <div class="md:flex md:items-center">
                        ...
                        <div class="md:w-2/3 md:items-end">
                            ...
                            {{-- <a href="/gestionCommandes">Retourner</a> --}}
                            <button id="ajouterCommande" class="md:w-1/3 mx-10 shadow bg-red-800 hover:bg-stone-700 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" >
                                Ajouter

            ...
            <div class="p-6 text-gray-900 flex flex-col space-y-4">
                <form class="w-full max-w-m m-auto" method="get" action="/extraitCommande">
                    ...
                    <div class="md:flex md:items-center mb-6">
                        ...
                        <div class="md:w-3/5">
                            <input class="bg-white appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="telephone" type="text" name="telephone" value="">
                        </div>
                    </div>
                    <div class="md:flex md:items-center mb-6">
                        <div class="md:w-1/5">
                        ...
                        <div class="md:w-4/5 flex h-11">
                            ...
                            <div class="md:w-1/2 flex">
                                ...
                                <select class="md:w-1/3block appearance-none w-full bg-white border border-gray-200 text-gray-700 py-2 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white" id="qtt_pizza" name="qtt_pizza">
                                    @for ($i = 0; $i < 10; $i++)
                                        <option>{{ $i }}</option>
                                    @endfor
                                </select>
                            ...
                            <div class="md:w-1/2 flex">
                                ...
                                {{-- <form method="post" action="">
                                    ...
                                    <button type="submit" name="ajouter_produit" id="ajouter_beverage" class="p-4 text-gray-900 flex"> --}}
                                        <img onclick="ajouterBeverage()" class="block h-9 w-auto fill-current text-gray-800" type="image" src="{{ asset('image/ajouter-icon.png') }}" alt="ajouter beverage" >
                                    {{-- </button>
                                </form> --}}
                            </div>
                        </div>
                            ...
                            <div class="md:w-1/2 flex">
                                ...
                                {{-- <form method="post" action="">
                                    ...
                                    <button type="submit" name="ajouter_produit" id="ajouter_dessert" class="p-4 text-gray-900 flex"> --}}
                                        <img onclick="ajouterDessert()" class="block h-9 w-auto fill-current text-gray-800" type="image" src="{{ asset('image/ajouter-icon.png') }}" alt="ajouter dessert" id="ajouter_dessert" >
                                    {{-- </button>
                                </form> --}}
                            </div>
